...
import com.example.spectre.databinding.FragmentSecondBinding;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonConnect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                binding.buttonCalibrate.setVisibility(View.VISIBLE);
        ...
        binding.buttonCalibrate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavHostFragment.findNavController(SecondFragment.this)
                        .navigate(R.id.action_SecondFragment_to_AnalyseFragment);
            }
        });
    }
